...
const Searchbar = ({ searchTerm, setSearchTerm, onSearch, onClear, activeSearch, sortBy, setSortBy }) => {
    ...
    return (
        <form className="searchbar" onSubmit={handleSearch}>
            ...
            <div className="sort-inline">
                <label className="sr-only" htmlFor="sort-select-inline">Ordenar</label>
